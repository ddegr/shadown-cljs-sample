...
if((x instanceof cljs.core.Keyword)){
var G__31193 = spec;
var G__31194 = spec_tools.transform.keyword__GT_string(spec,x);
...
if((x instanceof cljs.core.Keyword)){
var G__31195 = spec;
var G__31196 = spec_tools.transform.keyword__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31195,G__31196) : f.call(null,G__31195,G__31196));
} else {
return x;
...
if(typeof x === 'number'){
var G__31197 = spec;
var G__31198 = spec_tools.transform.number__GT_string(spec,x);
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(G__31197,G__31198) : f.call(null,G__31197,G__31198));
} else {
if(typeof x === 'string'){
return (f.cljs$core$IFn$_invoke$arity$2 ? f.cljs$core$IFn$_invoke$arity$2(spec,x) : f.call(null,spec,x));
} else {
...
}catch (e31200){if((e31200 instanceof Error)){
var ___$1 = e31200;
return x;
} else {
throw e31200;
...
spec_tools.transform.strip_extra_keys = (function spec_tools$transform$strip_extra_keys(p__31297,x){
var map__31298 = p__31297;
var map__31298__$1 = cljs.core.__destructure_map(map__31298);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31298__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.fail_on_extra_keys = (function spec_tools$transform$fail_on_extra_keys(p__31299,x){
var map__31300 = p__31299;
var map__31300__$1 = cljs.core.__destructure_map(map__31300);
var keys = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31300__$1,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460));
...
spec_tools.transform.strip_extra_values = (function spec_tools$transform$strip_extra_values(p__31303,x){
var map__31304 = p__31303;
var map__31304__$1 = cljs.core.__destructure_map(map__31304);
var items = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31304__$1,new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600));
