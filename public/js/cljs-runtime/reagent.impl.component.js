...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__27550 = c;
var G__27550__$1 = (((G__27550 == null))?null:G__27550.prototype);
if((G__27550__$1 == null)){
return null;
} else {
return G__27550__$1.reagentRender;
}
})() == null)))));
});
...
while (G__27642__i < G__27642__a.length) {G__27642__a[G__27642__i] = arguments[G__27642__i + 0]; ++G__27642__i;}
  args = new cljs.core.IndexedSeq(G__27642__a,0,null);
} 
...
var or__4253__auto__ = (function (){var G__27616 = c;
var G__27616__$1 = (((G__27616 == null))?null:G__27616.constructor);
if((G__27616__$1 == null)){
return null;
} else {
return G__27616__$1.displayName;
}
})();
...
var G__27617 = c;
var G__27617__$1 = (((G__27617 == null))?null:G__27617.constructor);
if((G__27617__$1 == null)){
return null;
} else {
return G__27617__$1.name;
}
}
});
...
var _STAR_current_component_STAR__orig_val__27625 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27626 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27626);

try{return reagent.impl.component.wrap_render(c,compiler);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27625);
}});
...
var c = this;
var G__27629_27647 = reagent.impl.component.goog$module$goog$object.get(c,"cljsRatom");
if((G__27629_27647 == null)){
} else {
reagent.ratom.dispose_BANG_(G__27629_27647);
}
...
var renders_27649 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383)], null));
var render_fun_27650 = cljs.core.first(cljs.core.vals(renders_27649));
...
if((cljs.core.count(renders_27649) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_27649))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_27650)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_27650], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var G__27630 = o;
reagent.impl.component.goog$module$goog$object.set(G__27630,cljs.core.name(k),v);
...
while (G__27653__i < G__27653__a.length) {G__27653__a[G__27653__i] = arguments[G__27653__i + 0]; ++G__27653__i;}
  args = new cljs.core.IndexedSeq(G__27653__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__27631 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__27632 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__27632);

try{return reagent.impl.component.functional_wrap_render(compiler,c);
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__27631);
}});
...
var vec__27633 = module$node_modules$react$index.useState((0));
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27633,(0),null);
var update_count = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__27633,(1),null);
...
var G__27636 = reagent.impl.component.goog$module$goog$object.get(reagent_state,"cljsRatom");
if((G__27636 == null)){
return null;
} else {
return reagent.ratom.dispose_BANG_(G__27636);
}
});
}),[]);
