...
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"default","default",-1987822328),new cljs.core.Keyword("spec-tools.swagger.core","default","spec-tools.swagger.core/default",1361779456)], null),new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32541 = cljs.core.get_global_hierarchy;
return (fexpr__32541.cljs$core$IFn$_invoke$arity$0 ? fexpr__32541.cljs$core$IFn$_invoke$arity$0() : fexpr__32541.call(null));
})());
...
spec_tools.swagger.core.accept_spec.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),(function (_,___$1,children,p__32546){
var map__32547 = p__32546;
var map__32547__$1 = cljs.core.__destructure_map(map__32547);
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32547__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32547__$1,new cljs.core.Keyword(null,"in","in",-1531184865));
...
var vec__32578 = spec_tools.impl.extract_form(spec);
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32583 = cljs.core.get_global_hierarchy;
return (fexpr__32583.cljs$core$IFn$_invoke$arity$0 ? fexpr__32583.cljs$core$IFn$_invoke$arity$0() : fexpr__32583.call(null));
})());
...
var map__32584 = spec_tools.swagger.core.transform.cljs$core$IFn$_invoke$arity$2(spec,new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"in","in",-1531184865),in$,new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"parameter","parameter",1978789597)], null));
var map__32584__$1 = cljs.core.__destructure_map(map__32584);
var properties = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32584__$1,new cljs.core.Keyword(null,"properties","properties",685819552));
var required = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32584__$1,new cljs.core.Keyword(null,"required","required",1807647006));
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p__32585){
var vec__32586 = p__32585;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32586,(0),null);
var map__32589 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32586,(1),null);
var map__32589__$1 = cljs.core.__destructure_map(map__32589);
var schema = map__32589__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__32589__$1,new cljs.core.Keyword(null,"type","type",1174270348));
...
var method_cache__4749__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var cached_hierarchy__4750__auto__ = cljs.core.atom.cljs$core$IFn$_invoke$arity$1(cljs.core.PersistentArrayMap.EMPTY);
var hierarchy__4751__auto__ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,new cljs.core.Keyword(null,"hierarchy","hierarchy",-1053470341),(function (){var fexpr__32590 = cljs.core.get_global_hierarchy;
return (fexpr__32590.cljs$core$IFn$_invoke$arity$0 ? fexpr__32590.cljs$core$IFn$_invoke$arity$0() : fexpr__32590.call(null));
})());
...
})(),(function (){var iter__4652__auto__ = (function spec_tools$swagger$core$iter__32591(s__32592){
return (new cljs.core.LazySeq(null,(function (){
var s__32592__$1 = s__32592;
while(true){
var temp__5753__auto__ = cljs.core.seq(s__32592__$1);
if(temp__5753__auto__){
var s__32592__$2 = temp__5753__auto__;
if(cljs.core.chunked_seq_QMARK_(s__32592__$2)){
var c__4650__auto__ = cljs.core.chunk_first(s__32592__$2);
var size__4651__auto__ = cljs.core.count(c__4650__auto__);
var b__32594 = cljs.core.chunk_buffer(size__4651__auto__);
if((function (){var i__32593 = (0);
while(true){
if((i__32593 < size__4651__auto__)){
var vec__32595 = cljs.core._nth(c__4650__auto__,i__32593);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32595,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32595,(1),null);
cljs.core.chunk_append(b__32594,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [status,(function (){var $ = response;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__32594),spec_tools$swagger$core$iter__32591(cljs.core.chunk_rest(s__32592__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__32594),null);
}
} else {
var vec__32598 = cljs.core.first(s__32592__$2);
var status = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32598,(0),null);
var response = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32598,(1),null);
...
var $__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"schema","schema",-1582001791).cljs$core$IFn$_invoke$arity$1($))?cljs.core.update.cljs$core$IFn$_invoke$arity$4($,new cljs.core.Keyword(null,"schema","schema",-1582001791),spec_tools.swagger.core.transform,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"schema","schema",-1582001791)], null)):$);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3($__$1,new cljs.core.Keyword(null,"description","description",-1428560544),cljs.core.fnil.cljs$core$IFn$_invoke$arity$2(cljs.core.identity,""));
})()], null),spec_tools$swagger$core$iter__32591(cljs.core.rest(s__32592__$2)));
}
} else {
return null;
}
...
var new$ = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__32601){
var vec__32602 = p__32601;
var in$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32602,(0),null);
var spec = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32602,(1),null);
return spec_tools.swagger.core.extract_parameter.cljs$core$IFn$_invoke$arity$2(in$,spec);
}),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([v], 0));
var merged = cljs.core.vec(cljs.core.reverse(cljs.core.first(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (p__32605,p){
var vec__32606 = p__32605;
var ps = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32606,(0),null);
var cache = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32606,(1),null);
var acc__$1 = vec__32606;
