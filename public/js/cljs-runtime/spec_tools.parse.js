...
var fexpr__31070 = ((cljs.core.sequential_QMARK_(type))?cljs.core.first:cljs.core.identity);
return (fexpr__31070.cljs$core$IFn$_invoke$arity$1 ? fexpr__31070.cljs$core$IFn$_invoke$arity$1(type) : fexpr__31070.call(null,type));
});
...
var G__31075 = spec_tools.impl.normalize_symbol(x);
var G__31076 = null;
var G__31077 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__31075,G__31076,G__31077) : spec_tools.parse.parse_form.call(null,G__31075,G__31076,G__31077));
} else {
if(cljs.core.seq_QMARK_(x)){
var G__31078 = spec_tools.impl.normalize_symbol(cljs.core.first(x));
var G__31079 = x;
var G__31080 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__31078,G__31079,G__31080) : spec_tools.parse.parse_form.call(null,G__31078,G__31079,G__31080));
} else {
if(cljs.core.truth_(cljs.spec.alpha.spec_QMARK_(x))){
var G__31191 = cljs.spec.alpha.form(x);
var G__31192 = options;
x = G__31191;
options = G__31192;
continue;
} else {
if(cljs.core.ifn_QMARK_(x)){
var G__31081 = spec_tools.impl.normalize_symbol(spec_tools.form.resolve_form.cljs$core$IFn$_invoke$arity$1(x));
var G__31082 = null;
var G__31083 = options;
return (spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3 ? spec_tools.parse.parse_form.cljs$core$IFn$_invoke$arity$3(G__31081,G__31082,G__31083) : spec_tools.parse.parse_form.call(null,G__31081,G__31082,G__31083));
} else {
...
var G__31084 = parse_data;
var G__31084__$1 = (((G__31084 == null))?null:new cljs.core.Keyword("spec-tools.parse","items","spec-tools.parse/items",1255627600).cljs$core$IFn$_invoke$arity$1(G__31084));
var G__31084__$2 = (((G__31084__$1 == null))?null:cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.parse.get_keys,G__31084__$1));
var G__31084__$3 = (((G__31084__$2 == null))?null:cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.concat,G__31084__$2));
var G__31084__$4 = (((G__31084__$3 == null))?null:cljs.core.seq(G__31084__$3));
if((G__31084__$4 == null)){
return null;
} else {
return cljs.core.set(G__31084__$4);
}
}
});
...
var map__31100 = spec_tools.impl.parse_keys(form);
var map__31100__$1 = cljs.core.__destructure_map(map__31100);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31100__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31100__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31100__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31100__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var key__GT_spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31100__$1,new cljs.core.Keyword(null,"key->spec","key->spec",1088543019));
var G__31101 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),new cljs.core.Keyword(null,"map","map",1371690461),new cljs.core.Keyword("spec-tools.parse","key->spec","spec-tools.parse/key->spec",1347735257),key__GT_spec,new cljs.core.Keyword("spec-tools.parse","keys","spec-tools.parse/keys",1331815460),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$variadic(req,opt,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([req_un,opt_un], 0)))], null);
var G__31101__$1 = (cljs.core.truth_((function (){var or__4253__auto__ = req;
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
} else {
return req_un;
}
})())?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31101,new cljs.core.Keyword("spec-tools.parse","keys-req","spec-tools.parse/keys-req",-1559250753),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(req,req_un))):G__31101);
...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__31101__$1,new cljs.core.Keyword("spec-tools.parse","keys-opt","spec-tools.parse/keys-opt",-1090203455),cljs.core.set(cljs.core.concat.cljs$core$IFn$_invoke$arity$2(opt,opt_un)));
} else {
return G__31101__$1;
}
}));
...
var vec__31102 = multi_spec_form;
...
var multi_method_symbol = first__31104__$1;
var ___$1 = seq__31103__$2;
var form = vec__31102;
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p__31105){
var vec__31106 = p__31105;
var spec_k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31106,(0),null);
var method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31106,(1),null);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$2((function (p1__31110_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__31110_SHARP_,options);
...
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__31113_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__31113_SHARP_,options);
}),cljs.core.rest(form));
...
var type_priority = (function (p1__31117_SHARP_){
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__31117_SHARP_),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724))){
return (1);
} else {
return (0);
}
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31118_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__31118_SHARP_,options);
}),cljs.core.rest(form))));
}));
...
var map__31122 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__31122__$1 = cljs.core.__destructure_map(map__31122);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31122__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
var map__31134 = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),form));
var map__31134__$1 = cljs.core.__destructure_map(map__31134);
var into = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31134__$1,new cljs.core.Keyword(null,"into","into",-150836029));
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","map-of","clojure.spec.alpha/map-of",2125010727,null),(function (_,p__31139,options){
var vec__31140 = p__31139;
var ___$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31140,(0),null);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31140,(1),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31140,(2),null);
...
spec_tools.parse.parse_form.cljs$core$IMultiFn$_add_method$arity$3(null,new cljs.core.Symbol("clojure.spec.alpha","tuple","clojure.spec.alpha/tuple",800350846,null),(function (_,p__31144,options){
...
var ___$1 = first__31147;
var values = seq__31146__$1;
var specs = cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__31143_SHARP_){
return spec_tools.parse.parse_spec_with_spec_ref(p1__31143_SHARP_,options);
}),values);
...
var type_priority = (function (p1__31148_SHARP_){
var G__31159 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"map","map",1371690461),(1),new cljs.core.Keyword(null,"multi-spec","multi-spec",1274719724),(0)], null);
var fexpr__31158 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(p1__31148_SHARP_);
return (fexpr__31158.cljs$core$IFn$_invoke$arity$1 ? fexpr__31158.cljs$core$IFn$_invoke$arity$1(G__31159) : fexpr__31158.call(null,G__31159));
});
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.deep_merge,cljs.core.sort_by.cljs$core$IFn$_invoke$arity$2(type_priority,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__31153_SHARP_){
return spec_tools.parse.parse_spec.cljs$core$IFn$_invoke$arity$2(p1__31153_SHARP_,options);
}),cljs.core.rest(form))));
}));
