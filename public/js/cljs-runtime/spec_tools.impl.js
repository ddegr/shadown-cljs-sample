...
var vec__31022 = cljs.core.rest(expr);
...
var vec__31025 = first__31024;
var s = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__31025,(0),null);
var form = seq__31023__$1;
...
var G__31030 = x;
var G__31030__$1 = (((G__31030 == null))?null:spec_tools.impl.polish(G__31030));
var G__31030__$2 = (((G__31030__$1 == null))?null:cljs.core.name(G__31030__$1));
if((G__31030__$2 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__31030__$2);
}
});
spec_tools.impl.un_key = (function spec_tools$impl$un_key(x){
var G__31031 = x;
var G__31031__$1 = (((G__31031 == null))?null:cljs.core.name(G__31031));
if((G__31031__$1 == null)){
return null;
} else {
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(G__31031__$1);
}
});
spec_tools.impl.with_key__GT_spec = (function spec_tools$impl$with_key__GT_spec(p__31032){
var map__31033 = p__31032;
var map__31033__$1 = cljs.core.__destructure_map(map__31033);
var data = map__31033__$1;
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31033__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31033__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31033__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31033__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
spec_tools.impl.with_real_keys = (function spec_tools$impl$with_real_keys(p__31034){
var map__31035 = p__31034;
var map__31035__$1 = cljs.core.__destructure_map(map__31035);
var data = map__31035__$1;
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31035__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31035__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
var G__31036 = data;
var G__31036__$1 = (cljs.core.truth_(req_un)?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__31036,new cljs.core.Keyword(null,"req-un","req-un",1074571008),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key)):G__31036);
if(cljs.core.truth_(opt_un)){
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__31036__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(cljs.core.mapv,spec_tools.impl.un_key));
} else {
return G__31036__$1;
}
});
spec_tools.impl.parse_keys = (function spec_tools$impl$parse_keys(form){
var m = (function (){var G__31040 = form;
var G__31040__$1 = (((G__31040 == null))?null:cljs.core.rest(G__31040));
if((G__31040__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__31040__$1);
}
})();
var G__31041 = m;
var G__31041__$1 = (cljs.core.truth_(new cljs.core.Keyword(null,"req","req",-326448303).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__31041,new cljs.core.Keyword(null,"req","req",-326448303),(function (p1__31037_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__31037_SHARP_)));
})):G__31041);
var G__31041__$2 = (cljs.core.truth_(new cljs.core.Keyword(null,"req-un","req-un",1074571008).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__31041__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008),(function (p1__31038_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,cljs.core.flatten(p1__31038_SHARP_)));
})):G__31041__$1);
var G__31041__$3 = (cljs.core.truth_(new cljs.core.Keyword(null,"opt-un","opt-un",883442496).cljs$core$IFn$_invoke$arity$1(m))?cljs.core.update.cljs$core$IFn$_invoke$arity$3(G__31041__$2,new cljs.core.Keyword(null,"opt-un","opt-un",883442496),(function (p1__31039_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(spec_tools.impl.polish,p1__31039_SHARP_));
})):G__31041__$2);
return spec_tools.impl.with_real_keys(spec_tools.impl.with_key__GT_spec(G__31041__$3));

});
spec_tools.impl.extract_keys = (function spec_tools$impl$extract_keys(form){
var map__31042 = (function (){var G__31043 = form;
var G__31043__$1 = (((G__31043 == null))?null:cljs.core.rest(G__31043));
if((G__31043__$1 == null)){
return null;
} else {
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,G__31043__$1);
}
})();
var map__31042__$1 = cljs.core.__destructure_map(map__31042);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31042__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31042__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31042__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31042__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var G__31044 = (function (){var and__4251__auto__ = (kw instanceof cljs.core.Symbol);
...
return cljs.core.boolean$(((cljs.core.seq_QMARK_(form))?(function (){var G__31045 = form;
var G__31045__$1 = (((G__31045 == null))?null:cljs.core.seq(G__31045));
var G__31045__$2 = (((G__31045__$1 == null))?null:cljs.core.first(G__31045__$1));
if((G__31045__$2 == null)){
return null;
} else {
var fexpr__31046 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Symbol("cljs.spec.alpha","nilable","cljs.spec.alpha/nilable",1628308748,null),null,new cljs.core.Symbol("clojure.spec.alpha","nilable","clojure.spec.alpha/nilable",-1718644550,null),null], null), null);
return (fexpr__31046.cljs$core$IFn$_invoke$arity$1 ? fexpr__31046.cljs$core$IFn$_invoke$arity$1(G__31045__$2) : fexpr__31046.call(null,G__31045__$2));
}
})():null));
});
/**
...
var len__4864__auto___31090 = arguments.length;
var i__4865__auto___31091 = (0);
while(true){
if((i__4865__auto___31091 < len__4864__auto___31090)){
args__4870__auto__.push((arguments[i__4865__auto___31091]));

var G__31092 = (i__4865__auto___31091 + (1));
i__4865__auto___31091 = G__31092;
continue;
} else {
}
break;
...
/** @this {Function} */
(spec_tools.impl.deep_merge.cljs$lang$applyTo = (function (seq31049){
var self__4852__auto__ = this;
return self__4852__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq31049));
}));

spec_tools.impl.unlift_keys = (function spec_tools$impl$unlift_keys(data,ns_name){
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__31056){
...
spec_tools.impl.keys_spec = (function spec_tools$impl$keys_spec(p__31062){
var map__31063 = p__31062;
var map__31063__$1 = cljs.core.__destructure_map(map__31063);
var req = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31063__$1,new cljs.core.Keyword(null,"req","req",-326448303));
var opt = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31063__$1,new cljs.core.Keyword(null,"opt","opt",-794706369));
var req_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31063__$1,new cljs.core.Keyword(null,"req-un","req-un",1074571008));
var opt_un = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__31063__$1,new cljs.core.Keyword(null,"opt-un","opt-un",883442496));
...
var pred_exprs = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [(function (p1__31060_SHARP_){
return cljs.core.map_QMARK_(p1__31060_SHARP_);
})], null),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (x){
return (function (p1__31061_SHARP_){
return cljs.core.contains_QMARK_(p1__31061_SHARP_,x);
});
}),req_keys));
