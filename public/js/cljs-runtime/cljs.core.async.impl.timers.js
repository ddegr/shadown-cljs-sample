...
var i_31495 = (0);
while(true){
if((i_31495 < arr.length)){
(arr[i_31495] = null);

var G__31496 = (i_31495 + (1));
i_31495 = G__31496;
continue;
} else {
}
...
var i_31518 = (self__.level + (1));
while(true){
if((i_31518 <= (new_level + (1)))){
(update[i_31518] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_31520 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_31520[i]));
} else {
x__$2.forward.push((((i < links_31520.length))?(links_31520[i]):null));
}

if((i < links_31520.length)){
(links_31520[i] = x__$2);
} else {
links_31520.push(x__$2);
}
...
var G__31532 = nx;
var G__31533 = (level__$1 - (1));
x = G__31532;
level__$1 = G__31533;
continue;
} else {
var G__31534 = x;
var G__31535 = (level__$1 - (1));
x = G__31534;
level__$1 = G__31535;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__31542 = nx;
var G__31544 = (level__$1 - (1));
x = G__31542;
level__$1 = G__31544;
continue;
} else {
var G__31546 = x;
var G__31547 = (level__$1 - (1));
x = G__31546;
level__$1 = G__31547;
continue;
}
