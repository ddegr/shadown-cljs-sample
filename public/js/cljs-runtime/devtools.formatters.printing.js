...
var len__4864__auto___30484 = arguments.length;
var i__4865__auto___30485 = (0);
while(true){
if((i__4865__auto___30485 < len__4864__auto___30484)){
args__4870__auto__.push((arguments[i__4865__auto___30485]));

var G__30490 = (i__4865__auto___30485 + (1));
i__4865__auto___30485 = G__30490;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq30340){
...
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30341,G__30342,seq30340__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__30383_SHARP_){
return (!((cljs.core.meta(p1__30383_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30417__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e30421){var _e__27522__auto__ = e30421;
return false;
}})();
if(cljs.core.truth_(or__4253__auto__)){
return or__4253__auto__;
...
}catch (e30426){var _e__27522__auto__ = e30426;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__30440 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__30441 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__30441);

try{var map__30445 = opts;
var map__30445__$1 = cljs.core.__destructure_map(map__30445);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30445__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__30440);
}});
...
var temp__5751__auto___30522 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5751__auto___30522)){
var managed_print_level_30523 = temp__5751__auto___30522;
var _STAR_print_level_STAR__orig_val__30461_30524 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__30462_30525 = managed_print_level_30523;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__30462_30525);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__30450_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__30450_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__30461_30524);
}} else {
job_fn();
}
