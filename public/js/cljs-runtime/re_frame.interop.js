...
return [(function (){var pred__27451 = cljs.core.instance_QMARK_;
var expr__27452 = reactive_val;
if(cljs.core.truth_((pred__27451.cljs$core$IFn$_invoke$arity$2 ? pred__27451.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__27452) : pred__27451.call(null,reagent.ratom.RAtom,expr__27452)))){
return "ra";
} else {
if(cljs.core.truth_((pred__27451.cljs$core$IFn$_invoke$arity$2 ? pred__27451.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__27452) : pred__27451.call(null,reagent.ratom.RCursor,expr__27452)))){
return "rc";
} else {
if(cljs.core.truth_((pred__27451.cljs$core$IFn$_invoke$arity$2 ? pred__27451.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__27452) : pred__27451.call(null,reagent.ratom.Reaction,expr__27452)))){
return "rx";
} else {
if(cljs.core.truth_((pred__27451.cljs$core$IFn$_invoke$arity$2 ? pred__27451.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__27452) : pred__27451.call(null,reagent.ratom.Track,expr__27452)))){
return "tr";
} else {
return "other";
}
