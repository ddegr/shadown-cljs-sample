...
var o30051 = temp__5751__auto__;
var temp__5751__auto____$1 = (o30051["core"]);
if(cljs.core.truth_(temp__5751__auto____$1)){
var o30052 = temp__5751__auto____$1;
return (o30052["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__27514__auto__ = f;
return (o__27514__auto__["toString"]).call(o__27514__auto__);
} else {
return "";
}
}catch (e30053){var _ = e30053;
return "";
}});
...
try{var o__27514__auto___30247 = t;
(o__27514__auto___30247["cljs$lang$ctorPrWriter"]).call(o__27514__auto___30247,t,writer);
}catch (e30060){var __30248 = e30060;
}
...
var char_code = (function (){var o__27514__auto__ = (new String(char$));
return (o__27514__auto__["charCodeAt"]).call(o__27514__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__27514__auto__ = String;
return (o__27514__auto__["fromCharCode"]).call(o__27514__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30074 = num_code;
switch (G__30074) {
case (1):
return (185);
...
var o__27514__auto__ = String;
return (o__27514__auto__["fromCharCode"]).call(o__27514__auto__,superscript_code);
});
/**
...
}catch (e30088){var _e__27522__auto__ = e30088;
return false;
}})())){
...
var vec__30089 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30089,(0),null);
...
var len__4864__auto___30254 = arguments.length;
var i__4865__auto___30255 = (0);
while(true){
if((i__4865__auto___30255 < len__4864__auto___30254)){
args__4870__auto__.push((arguments[i__4865__auto___30255]));

var G__30256 = (i__4865__auto___30255 + (1));
i__4865__auto___30255 = G__30256;
continue;
} else {
}
break;
...
var G__30259 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__30260 = cljs.core.butlast(remaining_tokens);
name_tokens = G__30259;
remaining_tokens = G__30260;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30093){
var G__30094 = cljs.core.first(seq30093);
var seq30093__$1 = cljs.core.next(seq30093);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30094,seq30093__$1);
}));
...
var vec__30139 = cljs.core.split_with((function (p1__30133_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__30133_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30139,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30139,(1),null);
...
var vec__30146 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30146,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30146,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__30262 = cljs.core.rest(remaining_tokens);
var G__30263 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__30262;
name_tokens = G__30263;
continue;
} else {
...
var vec__30151 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30151,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30151,(1),null);
var vec__30154 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30154,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30154,(1),null);
var vec__30157 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30157,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30157,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30157,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30157,(3),null);
...
var vec__30165 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30165,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30165,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30165,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30165,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30165,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30165,(5),null);
...
if(cljs.core.truth_(temp__5751__auto__)){
var vec__30170 = temp__5751__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30170,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30170,(1),null);
var vec__30173 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30173,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30173,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__30181 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__30181) : devtools.munging.parse_fn_info_deep.call(null,G__30181));
})()));
}
} else {
return fn_info;
...
var G__30266 = (arity + (1));
var G__30267 = (function (){var temp__5751__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5751__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30193){
var vec__30194 = p__30193;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30194,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30194,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30197_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__30197_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30198_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__30198_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30210){
var vec__30211 = p__30210;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30211,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30203){
var G__30204 = cljs.core.first(seq30203);
var seq30203__$1 = cljs.core.next(seq30203);
var self__4851__auto__ = this;
return self__4851__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30204,seq30203__$1);
}));
...
var o__27514__auto__ = f;
return (o__27514__auto__["getBasis"]).call(o__27514__auto__);
});
/**
...
}catch (e30223){var _e__27522__auto__ = e30223;
...
var G__30275 = (obj[cljs.core.first(path)]);
var G__30276 = cljs.core.rest(path);
obj = G__30275;
path = G__30276;
continue;
} else {
...
var _STAR_ = (function (accum,p__30234){
var vec__30235 = p__30234;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30235,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30235,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30238){
var vec__30239 = p__30238;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30239,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30239,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30239,(2),null);
...
var post_process = (function (p__30243){
var vec__30244 = p__30243;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30244,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__30244,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__30242_SHARP_){
return (obj[cljs.core.first(p1__30242_SHARP_)]);
}),sorted_matches);
